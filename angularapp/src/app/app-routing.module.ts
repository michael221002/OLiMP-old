...
const routes: Routes = [
  { path: 'newFile', loadChildren: () => import('./import/import.module').then(m => m.ImportModule), data: { pageName: 'NewFile' } },
  { path: 'initialiaze', loadChildren: () => import('./initialize/initialize.module').then(m => m.InitializeModule), data: { pageName: 'Initialiaze' } },
  { path: '', loadChildren: () => import('./employees/employees.module').then(m => m.EmployeesModule), data: { pageName: 'Employees' } },
